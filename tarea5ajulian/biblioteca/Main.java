...
public class Main {
    public static void main(String[] args) {
        ...
        while (continuar) {
            ...
            switch (opcion.trim()) {
                ...
                default -> JOptionPane.showMessageDialog(null, "Opción no válida. Por favor, selecciona una opción entre 1 y 9.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private static void agregarLibro(CatalogoLibros catalogo) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "✓ Libro agregado exitosamente:\n" + nuevoLibro, "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "✗ Error: Año o ISBN inválido. El año debe ser un número y el ISBN debe tener 4 dígitos.", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private static void buscarPorISBN(CatalogoLibros catalogo) {
        ...
        if (libro != null) {
            JOptionPane.showMessageDialog(null, "✓ Libro encontrado:\n\n" + libro, "Búsqueda Exitosa", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, "✗ No se encontró un libro con ISBN: " + isbn, "No Encontrado", JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private static void buscarPorAutor(CatalogoLibros catalogo) {
        ...
        if (!librosAutor.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "✗ No se encontraron libros del autor: " + autor, "No Encontrado", JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private static void prestarLibro(CatalogoLibros catalogo) {
        ...
        if (libro != null) {
            ...
            if (!libro.isDisponible()) {
                JOptionPane.showMessageDialog(null, "✓ Libro prestado exitosamente: " + libro.getTitulo(), "Éxito", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "✗ El libro no está disponible para préstamo.", "Error", JOptionPane.WARNING_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(null, "✗ Libro no encontrado con ISBN: " + isbn, "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private static void devolverLibro(CatalogoLibros catalogo) {
        ...
        if (libro != null) {
            libro.devolver();
            if (libro.isDisponible()) {
                JOptionPane.showMessageDialog(null, "✓ Libro devuelto exitosamente: " + libro.getTitulo(), "Éxito", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "✗ El libro ya estaba disponible.", "Información", JOptionPane.INFORMATION_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(null, "✗ Libro no encontrado con ISBN: " + isbn, "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private static void eliminarLibro(CatalogoLibros catalogo) {
        ...
        if (libro != null) {
            ...
            JOptionPane.showMessageDialog(null, "✓ Libro eliminado exitosamente: " + libro.getTitulo(), "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null, "✗ Libro no encontrado con ISBN: " + isbn, "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private static void mostrarCantidad(CatalogoLibros catalogo) {
        ...
        JOptionPane.showMessageDialog(null, "Cantidad de libros en el catálogo: " + cantidad, "Cantidad de Libros", JOptionPane.INFORMATION_MESSAGE);
    }
}